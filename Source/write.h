...
extern INDEX MaxIter, Nac, NacVar, NacEl, NregPQ, NregV, Ndc, Narea, Nslack,
    Nvolt, Bl, NZvolt, NXvolt, Nsvc, Ntcsc, NtcscVar, Nstatcom; /* FACTS */
extern VALUETYPE Tol, Sn, lambda, lambda_o, *dF, MaxdFi, *x0, *Dx, K3;
extern int GlobalArgc;
extern char **GlobalArgv;
extern bool Acont, PQcont, QRcont, Rcont, flagH, flagPoC, flagBS, flagPgMax,
    flagSmax;
