...
#endif
{
  ...
  for (i=0,ACptr=dataPtr->ACbus; ACptr!=NULL; ACptr=ACptr->Next){
    if (ACptr->Cont!=NULL) {
      if (strpbrk(ACptr->Type,"S")) {
        sprintf_s(str,"kg%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Kg);
      }
      else {
        sprintf_s(str,"d%-d",ACptr->Num);  fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Ang);
      }
      sprintf_s(str,"dP%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"V%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->V);
      sprintf_s(str,"dQ%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
    }
      ...
      sprintf_s(str,"Qr%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Qr);
      sprintf_s(str,"dQ%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
    }
      ...
      sprintf_s(str,"dP%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"Qg%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Qg);
      sprintf_s(str,"dQ%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
    }
    else if(strpbrk(ACptr->Type,"Z")) {
      sprintf_s(str,"d%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Ang);
      sprintf_s(str,"dP%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"Qz%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Qg);
      sprintf_s(str,"dQ%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
    }
    ...
    if(Acont && strpbrk(ACptr->Type,"A")){
      sprintf_s(str,"kg%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Kg);
      sprintf_s(str,"dPA%-d",ACptr->Area->N); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
    }
    if (PQcont) for(ELptr=ACptr->Reg;ELptr!=NULL;ELptr=ELptr->Next) {
      ...
      if(strpbrk(Eptr->Type,"PQNM")) {
	       ...
	       if(!strcmp(Eptr->Type,"RP")){
	         sprintf_s(str,"a%-d_%-d",I,J); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,Eptr->Ang);
	         sprintf_s(str,"dP%-d_%-d",I,J); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
	       }
	       else if(strpbrk(Eptr->Type,"PM")){
	         sprintf_s(str,"P%-d_%-d",I,J); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,Eptr->Cvar);
	         sprintf_s(str,"dP%-d_%-d",I,J); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      	 }
	       else if(!strcmp(Eptr->Type,"RQ")){
	         sprintf_s(str,"1/t%-d_%-d",I,J); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,Eptr->Tap);
	         sprintf_s(str,"dQ%-d_%-d",I,J); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
	       }
	       else {
	         sprintf_s(str,"Q%-d_%-d",I,J); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,Eptr->Cvar);
	         sprintf_s(str,"dQ%-d_%-d",I,J); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
	       }
      }
    }
    if (ACptr->Gen!=NULL) {
      i=ACptr->Gen->Nvar;
      sprintf_s(str,"dPg%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dQg%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dEq%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dEd%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dVd%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dVq%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dId%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dIq%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dVr%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dVi%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      sprintf_s(str,"dIa%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",++i,str,dF[i]);
      i=ACptr->Gen->Nvar;
      if (strpbrk(ACptr->cont,"E")) {
        sprintf_s(str,"Qg%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Qg);
      } else {
        sprintf_s(str,"Eq%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Eq);
      }
      sprintf_s(str,"dg%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->dg);
      sprintf_s(str,"Vr%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Vr);
      sprintf_s(str,"Vi%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Vi);
      sprintf_s(str,"Ir%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Ir);
      sprintf_s(str,"Ii%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Ii);
      sprintf_s(str,"Vq%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Vq);
      sprintf_s(str,"Vd%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Vd);
      sprintf_s(str,"Iq%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Iq);
      sprintf_s(str,"Id%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Id);
      if (strpbrk(ACptr->cont,"I")) {
	       sprintf_s(str,"Qg%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Qg);
      } else {
	       sprintf_s(str,"Ia%-d",ACptr->Num); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",++i,str,ACptr->Gen->Ia);
      }
    }
  }
  ...
  for(k=0,SVCptr=dataPtr->SVCbus;SVCptr!=NULL;SVCptr=SVCptr->Next){
      ...
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,SVCptr->Qsvc);
      sprintf_s(str,"Fsvc%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"Bv%-d",k);i++;       fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,SVCptr->Bv);
      sprintf_s(str,"Fsvc%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
  ...
  for(k=0,TCSCptr=dataPtr->TCSCbus;TCSCptr!=NULL;TCSCptr=TCSCptr->Next){
      ...
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,TCSCptr->Ptcsc);
      sprintf_s(str,"Ftcsc%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
  ...
  for(k=0,STATCOMptr=dataPtr->STATCOMbus;STATCOMptr!=NULL;STATCOMptr=STATCOMptr->Next){
      ...
      sprintf_s(str,"Vcont%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"theta%-d",k);i++;
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,STATCOMptr->theta);
      sprintf_s(str,"Cont%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"Vdc%-d",k);i++;
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,STATCOMptr->Vdc);
      sprintf_s(str,"Loss%-d_%-d",k,++l);  fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"k%-d",k);i++;
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,STATCOMptr->k);
      sprintf_s(str,"ReS%-d_%-d",k,++l);   fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"alpha%-d",k);i++;
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,STATCOMptr->alpha);
      sprintf_s(str,"ImS%-d_%-d",k,++l);   fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"Pstat%-d",k);i++;
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,STATCOMptr->P);
      sprintf_s(str,"Pstat%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      sprintf_s(str,"Qstat%-d",k);i++;
      fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,STATCOMptr->Q);
      sprintf_s(str,"Qstat%-d_%-d",k,++l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
  }
                             /* END FACTS */
  ...
  if (flagH) {
    ...
    for (i=N,ACptr=dataPtr->ACbus; ACptr!=NULL; ACptr=ACptr->Next){
      i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
      sprintf_s(str,"gP%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
      sprintf_s(str,"gQ%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      if(Acont && strpbrk(ACptr->Type,"A")){
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gPA%-d",ACptr->Area->N); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      }
      if (PQcont) for(ELptr=ACptr->Reg;ELptr!=NULL;ELptr=ELptr->Next) {
	       Eptr=ELptr->Eptr;
        if(strpbrk(Eptr->Type,"PQNM")) {
          ...
          if(!strcmp(Eptr->Type,"PM")){
            i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
            sprintf_s(str,"gP%-d_%-d",I,J); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
          } else {
            i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
            sprintf_s(str,"gQ%-d_%-d",I,J); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
          }
        }
      }
      if (ACptr->Gen!=NULL) {
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gPg%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gQg%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gEq%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gEd%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gVd%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gVq%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gId%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gIq%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gVr%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gVi%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gIa%-d",ACptr->Num); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      }
    }
    for(k=0,DCptrR=dataPtr->DCbus;DCptrR!=NULL;DCptrR=DCptrR->Next){
      if(!strcmp(DCptrR->Type,"R")){
        for (k++,l=1;l<=11;l++){
          i++; sprintf_s(str,"w%-d",i-N); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
          sprintf_s(str,"gdc%-d_%-d",k,l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
        }
      }
    }
    ...
    for(k=0,SVCptr=dataPtr->SVCbus;SVCptr!=NULL;SVCptr=SVCptr->Next){
      for (k++,l=1;l<=3;l++){
        i++; sprintf_s(str,"wsvc%-d_%-d",k,l); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gsvc%-d_%-d",k,l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      }
    }
    for(k=0,TCSCptr=dataPtr->TCSCbus;TCSCptr!=NULL;TCSCptr=TCSCptr->Next){
      for (k++,l=1;l<=7;l++){
        i++; sprintf_s(str,"wtcsc%-d_%-d",k,l); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gtcsc%-d_%-d",k,l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      }
    }
    for(k=0,STATCOMptr=dataPtr->STATCOMbus;STATCOMptr!=NULL;STATCOMptr=STATCOMptr->Next){
      for (k++,l=1;l<=7;l++){
        i++; sprintf_s(str,"wstat%-d_%-d",k,l); fCustomPrint(OutFile,"%4d %8s %-11.5g\n",i,str,x0[i-N]);
        sprintf_s(str,"gstat%-d_%-d",k,l); fCustomPrint(OutFilep,"%4d %8s %-11.5g\n",i,str,dF[i]);
      }
    }
				                       /* END OF FACTS */
